...
class Notification(object):
    ...
    def send(self):
        bus = dbus.SystemBus()
        valueService = bus.get_object(
            'com.nublic.notification', '/com/nublic/notification/Messages')
        message_sender = valueService.get_dbus_method(
            'new_message', 'com.nublic.notification')
